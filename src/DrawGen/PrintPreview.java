    ...
    private void DoPrintPreview()
    {
        if (this.pDrawGenView.getMyPrintService() == null)
        {
            ...
            PrintService SelectedPrtService = (PrintService) JOptionPane.showInputDialog(
                    this,
                    "No default printer is set, which print preview needs in order to get the printer page dimensions",
...
//              double xPx2PtScaleFactor = this.pDrawGenView.getPx2PtScaleFactor().get("x");
    ...
    private void initComponents()
    {
        ...
        jPanelPrintPreview = new javax.swing.JPanel();
        ...
        jButtonPrint.setMaximumSize(new java.awt.Dimension(60, 27));
        jButtonPrint.setMinimumSize(new java.awt.Dimension(33, 20));
        ...
        jSeparator1.setSeparatorSize(new java.awt.Dimension(25, 18));
        jToolBar1.add(jSeparator1);

        jButtonPageSetup.setText("Page Setup");
        jButtonPageSetup.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jButtonPageSetup.setFocusable(false);
        jButtonPageSetup.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jButtonPageSetup.setMaximumSize(new java.awt.Dimension(100, 27));
        ...
        jSeparator2.setSeparatorSize(new java.awt.Dimension(25, 18));
        ...
        jComboBoxZoom.setMinimumSize(new java.awt.Dimension(70, 18));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    .addGap(40, 40, 40)
                    .addComponent(jScrollPanePrintPreview, javax.swing.GroupLayout.PREFERRED_SIZE, 543, Short.MAX_VALUE)
                    .addContainerGap()))
        );
